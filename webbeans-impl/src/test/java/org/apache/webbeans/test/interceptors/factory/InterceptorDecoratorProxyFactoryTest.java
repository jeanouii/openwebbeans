...
public class InterceptorDecoratorProxyFactoryTest extends AbstractUnitTest
{
    ...
    public void testEnsureOneProxyPerAT()
    {
        ...
        final AnnotatedTypeImpl at = new AnnotatedTypeImpl<DummyBean>(context, context.getBeanManagerImpl().createAnnotatedType(DummyBean.class));
        final AnnotatedTypeConfiguratorImpl configurator = new AnnotatedTypeConfiguratorImpl<DummyBean>(context, at);
        ...
        final AnnotatedTypeImpl at2 = new AnnotatedTypeImpl<DummyBean>(context, context.getBeanManagerImpl().createAnnotatedType(DummyBean.class));
        final AnnotatedTypeConfiguratorImpl configurator2 = new AnnotatedTypeConfiguratorImpl<DummyBean>(context, at2);
